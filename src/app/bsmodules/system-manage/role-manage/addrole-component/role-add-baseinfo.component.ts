...
import {addRoleBaseForm} from "../../../../common/form/stystem.manage/add-role-manage/add-role-baseinfo.form";
...
export class RoleAddBaseinfoComponent {
    // [x: string]: any;
    public model:addRoleBaseForm = new addRoleBaseForm();
    ...
    onSubmit() {
        ...
        this.rolemanaeSev.saveRoleInfo(this.model).subscribe(res=>{
            ...
            if(res && res[CommonEnum.SERVER_STATUS_KEY] == CommonEnum.SERVER_STATUS_DATE_KEY){
                ...
                this.helper.navigate('/admin/systems/rolemanage',this.i18n.fanyi('RM.listPage.html.title'),{});
            }else {
                this._msg.error(res[CommonEnum.SERVER_MES_KEY]);
            }
        })
